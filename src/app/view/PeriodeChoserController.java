/* Decompiler 21ms, total 322ms, lines 55 */
package app.view;
...
public class PeriodeChoserController {
   @FXML
   ...
   public void initialize() {
      ...
      String sql = "SELECT DISTINCT monthYear FROM register ORDER BY monthYear DESC LIMIT 3";
      ...
      try {
         ...
         while(rst.next()) {
            this.periodeCombo.getItems().add(rst.getString("monthYear"));
         }
